...
public class ProductoAdapter extends RecyclerView.Adapter<ProductoAdapter.ProductoViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductoViewHolder holder, int position) {
        ...
        if (producto.getStockActual() <= producto.getStockMin()) {
            holder.ivStockStatus.setImageResource(R.drawable.ic_red_circle);
        } else {
            holder.ivStockStatus.setImageResource(R.drawable.ic_green_circle);
        }
    ...
    public class ProductoViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView ivStockStatus;  // Agregamos esta línea
        ...
        public ProductoViewHolder(@NonNull View itemView) {
            ...
            ivStockStatus = itemView.findViewById(R.id.ivStockStatus);  // Y esta línea
    ...
    private void mostrarDialogoDetalle(Producto producto) {
        ...
        Button btnDecrease = viewInflated.findViewById(R.id.btnDecrease);
        Button btnIncrease = viewInflated.findViewById(R.id.btnIncrease);
